  ...
  tablet:{title:'Curso de Tablet',group:'CURSOS',icon:'📱',eyebrow:'Curso',lead:'Uso operacional do tablet e organização das informações.',html:`<div class="def-item">
      ...
      <table class="q-table">
        ...
        <tbody>
          ...
          <tr><td class="q-code">03</td><td class="q-meaning">Dirigir sem cinto de segurança</td><td>\`}00</td></tr>
          <tr><td class="q-code">04</td><td class="q-meaning">Dirigir Alcoolizado</td><td>\`}.000</td></tr>
      ...
      <table class="q-table">
        ...
        <tbody>
          <tr><td class="q-code">01</td><td class="q-meaning">Desobediência</td><td>15</td><td>\`}.000</td></tr>
          ...
          <tr><td class="q-code">04</td><td class="q-meaning">Roubo de Departamento</td><td>35</td><td>\tablet:{title:'Curso de Tablet',group:'CURSOS',icon:'📱',eyebrow:'Curso',lead:'Uso operacional do tablet e organização das informações.',html:`0.000</td></tr>
          ...
          <tr><td class="q-code">09</td><td class="q-meaning">Porte de Entorpecentes</td><td>15</td><td>\tablet:{title:'Curso de Tablet',group:'CURSOS',icon:'📱',eyebrow:'Curso',lead:'Uso operacional do tablet e organização das informações.',html:`.000</td></tr>
        </tbody>
      </table>
      ...
      <table class="q-table">
        ...
        <tbody>
          ...
          <tr><td class="q-code">02</td><td class="q-meaning">Porte de arma ilegal</td><td>30</td><td>\$3.000</td></tr>
          <tr><td class="q-code">03</td><td class="q-meaning">Corrida ilegal</td><td>30</td><td>\$5.000</td></tr>
          <tr><td class="q-code">04</td><td class="q-meaning">Roubo de Departamento</td><td>35</td><td>\tablet:{title:'Curso de Tablet',group:'CURSOS',icon:'📱',eyebrow:'Curso',lead:'Uso operacional do tablet e organização das informações.',html:`<div class="def-item">
          <div class="def-term">🔒 PRISÕES HOJE</div>
          <div class="def-desc">Total de prisões acumuladas no dia atual.</div>
        </div>
        <div class="def-item">
      ...
      <div class="page-footer">
        <button class="footer-btn" onclick="showPage('curso-modulacao')">← Anterior</button>
        <button class="footer-btn" onclick="showPage('curso-acompanhamento')">Próximo: Curso Acompanhamento →</button>
      </div>`},
